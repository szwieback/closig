...
'''
from closig.model import SeasonalVegLayer, HomogSoilLayer, LayeredCovModel, TildedModel, ContHetDispModel, ScattSoilLayer
...
model = TildedModel([shrubs_a, shrubs_b], fractions=[
    0, 1], name='Shrubs')
