...
from expansion import SmallStepBasis, TwoHopBasis
...
def plot_triangles(roi, p0, pfig):
    ...
    vabs = {'small steps': 90, 'two hops': 20}
    ...
    for jbase, basename in enumerate(bases):
        ...
        triangle_plot(b, np.mean(cclosures, axis=(1, 2)), ax=ax, vabs=vabs[basename], diagonal_lines=True)
...
if __name__ == '__main__':
    rois = ['rocky', 'mountains', 'grass', 'fields']
    for roi in rois:
